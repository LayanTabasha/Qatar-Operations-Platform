...
contactsRouter.post("/", authorizeRoles(...ROLE_GROUPS.operationalManage), createContactRecord);
contactsRouter.patch("/:id", authorizeRoles(...ROLE_GROUPS.operationalManage), updateContactRecord);
contactsRouter.delete("/:id", authorizeRoles(...ROLE_GROUPS.operationalManage), deleteContactRecord);
