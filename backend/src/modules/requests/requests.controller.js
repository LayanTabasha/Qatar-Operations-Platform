...
export const updateRequestRecord = asyncHandler(async (req, res) => {
  if (req.user.role === "admin" && (Object.hasOwn(req.body, "status") || Object.hasOwn(req.body, "hq_response"))) {
    throw new ApiError(403, "FORBIDDEN", "Only HQ users can update Request status or HQ response");
  }
