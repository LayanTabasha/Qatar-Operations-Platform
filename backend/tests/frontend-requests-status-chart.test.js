...
describe("Homepage Requests Status component", () => {
  ...
  it("loads before Homepage and Sites while preserving the external caller", () => {
    ...
    expect(sources.indexOf("frontend/pages/homepage/home-page.js?v=20260818-homepage-requests-status-v1")).toBeGreaterThan(componentIndex);
    expect(sources.indexOf("js/sites-page.js?v=20260818-fault-lifecycle-v1")).toBeGreaterThan(componentIndex);
