...
describe("Homepage Recent Activity component", () => {
  ...
  it("loads before every external caller and preserves their global calls", () => {
    ...
    for (const caller of ["frontend/pages/homepage/home-page.js?v=20260818-homepage-kpi-orchestrator-v1", "frontend/shared/modals/modal-submit.js?v=20260825-fault-visit-ux-v1", "frontend/pages/settings/settings-page.js?v=20260820-settings-page-v1", "app.js?v=20260825-related-fault-selector-v3"]) {
    ...
    expect(read("frontend/shared/modals/modal-submit.js")).toContain("renderActivity();");
