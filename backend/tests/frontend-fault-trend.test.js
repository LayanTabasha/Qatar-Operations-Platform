...
function runtime() {
  const dom = new JSDOM(`<!doctype html><select id="fault-trend-site"></select><select id="fault-trend-range"><option value="7">Last 7 Days</option><option value="30" selected>Last 30 Days</option><option value="90">Last 90 Days</option><option value="180">Last 180 Days</option><option value="365">Last 365 Days</option></select><div id="fault-trend-subtitle"></div><div id="fault-trend-detail-title"></div><div id="fault-trend-context"></div><div id="fault-trend-total"></div><div id="fault-trend-site-list"></div><div id="fault-trend-chart"></div>`, { url: "http://localhost/" });
  const charts = [];
  class ChartMock {
