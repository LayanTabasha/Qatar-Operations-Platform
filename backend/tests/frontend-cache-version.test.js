...
const SITES_DATA_MAPPERS_VERSION = "20260825-site-visit-lifecycle-v1";
...
const STATE_OWNERSHIP_VERSION = "20260825-fault-resolution-v1";
...
const FAULT_MODALS_VERSION = "20260825-fault-resolution-v1";
const MODAL_CONFIGS_VERSION = "20260825-site-visit-lifecycle-v1";
const MODAL_CORE_VERSION = CONTACTS_ADMIN_VERSION;
const MODAL_SUBMIT_VERSION = CONTACTS_ADMIN_VERSION;
const HOMEPAGE_COMPACT_VERSION = "20260825-visit-activity-v2";
const CONTENT_RECORD_ACTIONS_VERSION = "20260818-legacy-content-actions-v3";
const APP_VERSION = CONTACTS_ADMIN_VERSION;
