...
const CONTACTS_ADMIN_VERSION = "20260825-contacts-admin-v1";
const FAULT_VISIT_LINKS_VERSION = "20260825-fault-visit-links-v2";
const FAULT_VISIT_UX_VERSION = "20260825-fault-visit-ux-v1";
const FAULT_VISIT_SELECTOR_VERSION = "20260825-fault-visit-selector-v2";
const RELATED_FAULT_SELECTOR_VERSION = "20260825-related-fault-selector-v3";
const REQUEST_FAULT_LINK_VERSION = "20260827-request-fault-link-v1";
const REQUEST_PRIORITY_INLINE_VERSION = "20260827-request-priority-inline-v2";
...
const VISIT_ACTIVITY_VERSION = "20260825-site-visit-lifecycle-v1";
const FAULT_STATUS_VERSION = FAULT_VISIT_LINKS_VERSION;
...
const SITES_DATA_MAPPERS_VERSION = FAULT_VISIT_LINKS_VERSION;
const SITES_SHARED_VERSION = "20260818-sites-shared-v1";
const SITES_LIST_VERSION = "20260818-sites-list-v1";
const SITE_VISITS_VERSION = RELATED_FAULT_SELECTOR_VERSION;
...
const STATE_OWNERSHIP_VERSION = REQUEST_FAULT_LINK_VERSION;
const PLATFORM_HEALTH_ALERT_VERSION = "20260830-platform-health-alert-v1";
const AUTH_ROUTER_OWNERSHIP_VERSION = PLATFORM_HEALTH_ALERT_VERSION;
const REQUESTS_SHARED_VERSION = REQUEST_PRIORITY_INLINE_VERSION;
const REQUESTS_LIST_VERSION = REQUEST_PRIORITY_INLINE_VERSION;
const REQUEST_DETAIL_VERSION = REQUEST_FAULT_LINK_VERSION;
const REQUEST_FORM_VERSION = REQUEST_FAULT_LINK_VERSION;
const REQUESTS_PAGE_VERSION = REQUEST_PRIORITY_INLINE_VERSION;
...
const PLATFORM_HEALTH_VERSION = "20260825-platform-health-v2";
...
const FAULT_MODALS_VERSION = FAULT_VISIT_SELECTOR_VERSION;
const MODAL_CONFIGS_VERSION = "20260825-site-visit-lifecycle-v1";
const MODAL_CORE_VERSION = REQUEST_FAULT_LINK_VERSION;
const MODAL_SUBMIT_VERSION = FAULT_VISIT_UX_VERSION;
const HOMEPAGE_COMPACT_VERSION = PLATFORM_HEALTH_ALERT_VERSION;
const CONTENT_RECORD_ACTIONS_VERSION = "20260818-legacy-content-actions-v3";
const APP_VERSION = RELATED_FAULT_SELECTOR_VERSION;
...
describe("frontend cache-version integrity", () => {
  ...
  it("loads the Requests response UX with its current token", () => {
    ...
    expect(index).toContain(`frontend/shared/platform-health-alert.js?v=${PLATFORM_HEALTH_ALERT_VERSION}`);
    ...
    expect(index).toContain(`frontend/pages/contacts/contacts-page.js?v=${CONTACTS_ADMIN_VERSION}`);
